--[[
    Рабочий скрипт для автопарирования и закручивания мяча с GUI
]]
...
function parryBall()
    ...
    -- Отправка сигнала на парирование
...
RunService.Heartbeat:Connect(function()
    ...
    -- Если мяч найден, выполняем парирование и закручивание
    if nearestBall then
        parryBall()
